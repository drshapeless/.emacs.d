...
(let (
  ...
  (custom-theme-set-faces
   ...
   ;; font lock
   `(font-lock-bracket-face              ((t (:foreground ,sl/white))))
   ...
   `(font-lock-doc-markup-face           ((t (:foreground ,sl/yellow))))
   `(font-lock-escape-face               ((t (:foreground ,sl/white))))
   `(font-lock-function-name-face        ((t (:foreground ,sl/green))))
   `(font-lock-keyword-face              ((t (:foreground ,sl/blue))))
   `(font-lock-misc-punctuation-face     ((t (:foreground ,sl/white))))
   `(font-lock-negation-char-face        ((t (:foreground ,sl/yellow))))
   `(font-lock-number-face               ((t (:foreground ,sl/yellow))))
   `(font-lock-operator-face             ((t (:foreground ,sl/blue))))
   `(font-lock-preprocessor-face         ((t (:foreground ,sl/yellow))))
   `(font-lock-property-face             ((t (:foreground ,sl/crazy-green))))
   `(font-lock-punctuation-face          ((t (:foreground ,sl/white))))
   `(font-lock-regexp-face               ((t (:foreground ,sl/pale-orange))))
   `(font-lock-regexp-grouping-backslash ((t (:foreground ,sl/white :bold t))))
   `(font-lock-regexp-grouping-construct ((t (:foreground ,sl/white :bold t))))
