...
(custom-set-variables
 ...
 '(package-selected-packages
   '(htmlize auto-package-update projectile pinentry pass mentor org-roam json-mode mood-line emms ox-slimhtml yasnippet which-key w3m valign use-package swift-mode pdf-view-restore org-pdftools magit ivy-rich helpful exwm eglot diminish counsel company autothemer async))
